"""
generate_total_history.py
~~~~~~~~~~~~~~~~~~~~~~~~~~
Generate a single ~500-word total_history summary merging all 20 annual
summaries into a narrative of the CSCL field's evolution 2006–2025.

Stores result in EditorialsCache.total_history.summary and writes a report.

Run from workspace root:
    python scripts/generate_total_history.py
"""
...
def main() -> None:
    ...
    if cache.total_history.has_summary():
        print("total_history already has a summary — regenerating.")
    ...
    cache.total_history.summary = EditorialSummary(
    ...
    print(f"\n--- Total History Preview (first 200 words) ---")
